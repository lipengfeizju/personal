...
In the SGVB method, for each data sample \\(x_i\\), both of these two log likelihoods are affected by the randomness of latent variable \\( z_{i,l}\\). To make the learning and inference more efficient, the ELBO can be rewritten as
